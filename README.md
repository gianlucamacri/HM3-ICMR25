...
You can download the pre--extracted features from [this-link-todo](todo) and extract their content to `src/data/features`.
```
TODO (using zenodo? e.g. https://zenodo.org/records/15301472)
```
